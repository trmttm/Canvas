...
def get_request_model(xy_rect: Tuple[int, int] = (20, 20), wh_rect: Tuple[int, int] = (50, 20), border_color='black',
    ...
    request_model = {
        '1': get_request_model_01(xy_rect, wh_rect, border_color, border_width, fill, tags_rect),
        '2': get_request_model_02(xy_text, text, text_color, font_size, wh_text, text_rotation, tags_text),
    }
