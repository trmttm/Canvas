...
class MyTestCase(unittest.TestCase):
    def test_use_case(self):
        ...
        mouse.configure(0, upon_mouse_click, mouse.is_left_click, {'shape_id': (f'rect_{5}',), 'width': 1})
        mouse.configure(1, upon_mouse_click, mouse.is_right_click, {'shape_id': (f'rect_{6}',), 'width': 10})
